-- forked from https://raw.githubusercontent.com/stysscythe/script/main/LibTest.lua to make modifications that fits my script more, no intent to steal
...
function Lib.Window(Title)
	...
	LibraryTitle.Text = "Last Letter Autofarm"
